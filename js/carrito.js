...
function abrirCheckout() {
    ...
    if (!usuarioLogueadoStr) {
        Swal.fire({
            title: '¡Inicia sesión!',
            text: 'Necesitas iniciar sesión o registrarte para realizar una compra.',
            icon: 'warning',
...
function comprarCarrito() {
    ...
    fetch('http://localhost:3000/api/comprar', {
        ...
        .then(data => {
            ...
            usuario.historialCompras = data.historial;
            ...
            Toastify({
                text: "¡Compra exitosa! Revisa tu historial en 'Mi Cuenta'.",
                duration: 4000,
                close: true,
                gravity: "top",
                position: "right",
        ...
        .catch(error => {
            console.error(error);
            Swal.fire('Error', 'Hubo un error al procesar tu compra.', 'error');
        });
}
